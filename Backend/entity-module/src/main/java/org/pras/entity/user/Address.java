...
import org.pras.entity.utils.AddressTypes;
...
@Data
@Entity
@Table(schema = Constants.SCHEMA_JEWEL, name = "m_addrs_dtls")
public class Address {

	@Id
	@Column(name = "addr_id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "addrs_seq")
	@SequenceGenerator(schema = Constants.SCHEMA_JEWEL, name = "addrs_seq", allocationSize = 1, initialValue = 1000)
	private long addrId;
